    ...
    entries.forEach(function (entry) {
      if (entry.isIntersecting) {
        animatedEls.forEach(function (el) {
          return el.classList.add('slide-up');
        });
...
function scrollTo(clickedEl, viewEl) {
  clickedEl.addEventListener('click', function (e) {
    e.preventDefault();
    window.scrollTo({
      top: viewEl.offsetTop - 89.59,
      // Adjust based on your fixed nav height
      behavior: "smooth"
    });
  });
}
document.addEventListener('DOMContentLoaded', function () {
  ...
  var meshEl = document.querySelector('.hero__mesh');
  var awardSectionEl = document.querySelector('.award-section');
  var scrollUpAnimatedAwardsEls = document.querySelectorAll('.scroll-up-animated--awards');
  var scrollToServicesBtnEl = document.getElementById('scrollToServicesBtn');
  var homeLinkEl = document.getElementById('homeLink');
  var servicesLinkEl = document.getElementById('servicesLink');
  var aboutLinkEl = document.getElementById('aboutLink');
  var projectsLinkEl = document.getElementById('projectsLink');
  var contactLinkEl = document.getElementById('contactLink');
  var servicesSectionEl = document.getElementById('servicesSection');
  var aboutSectionEl = document.getElementById('aboutSection');
  var projectsSectionEl = document.getElementById('projectsSection');
  var contactSectionEl = document.getElementById('contactSection');
  var projectsSet1Els = document.querySelectorAll('.projects-set--1');
  var projectsSet2Els = document.querySelectorAll('.projects-set--2');
  var projectsSet3Els = document.querySelectorAll('.projects-set--3');
  ...
  if (awardSectionEl) {
    var awardsArray = _toConsumableArray(scrollUpAnimatedAwardsEls);
